...
angular.module('stockDog2App')
  .service('WatchlistService', function WatchlistService() {
    ...
    var loadModel = function () {
      var model = {
        watchlists: localStorage['StockDog2.watchlists'] ?
          JSON.parse(localStorage['StockDog2.watchlists']) : [],
        nextId: localStorage['StockDog2.nextId'] ?
          parseInt(localStorage['StockDog2.nextId']) : 0
      };
    ...
    var saveModel = function () {
      localStorage['StockDog2.watchlists'] = JSON.stringify(Model.watchlists);
      localStorage['StockDog2.nextId'] = Model.nextId;
    };
